...
export async function POST(req) {
  ...
  db.prepare("INSERT INTO attempts(question_id,exam_id,kp_id,user_answer,correct,score,feedback,mode,created_at) VALUES(?,?,?,?,?,?,?,?,?)")
    .run(questionId, q.exam_id, q.kp_id, "[不会做]", 0, 0, "", "practice", nowStamp());
