...
数学公式用 LaTeX 并用 $...$ 或 $$...$$ 包裹,不要裸露反斜杠命令。输出 Markdown,结构:## 核心概念 / ## 考点解析 / ## 易错点 / ## 一个例子。语言平实,面向有行业经验的成年考生,不要废话。(标题也要翻译成目标语言)。如果资料语言与输出语言不同,专业术语可保留资料原文并附翻译,其余内容不要混合语言。` + langInstruction(user.lang),
      { temperature: 0.4 }
    );
