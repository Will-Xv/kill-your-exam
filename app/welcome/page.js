...
const L = {
  ...
  "zh-HK": { enter:"進入應用", badge:"你的私人 AI 備考殺手", h1a:"任何考試,", h1b:"都係獵物。",
    ...
    feats:[["🗡️","追殺計劃","先摸清獵物。上載課程大綱同資料,佢會幫呢一科畫出知識點地圖,標清楚邊啲已經穩陣、邊啲仲虛,再揪出真正拖低成績嘅根源。幾科考試一齊排期,倒數同「今日要做乜」一目了然。"],["📖","學習 + 練習","跟住就向住弱項開弓。講解同練習題都由你嘅資料生出嚟,無限出題、即刻批改;可以打字、用觸控筆手寫,或者影相上載。除咗操練,仲可以靠辯論、蘇格拉底式追問、錯題大佬戰嚟學。答錯嘅會喺 1/3/7/15/30 日之後返嚟搵你,直到真係識為止。覺得分數批得唔公道?就喺嗰條題目下面追問、同 AI 拗——你講得通,佢就改返個分。"],["💬","問問殺手","你嘅軍師隨傳隨到。佢讀得你嘅檔案、開得考試、排得計劃、派得功課,連介面都幫到你改——郁手之前會問你一聲。諗唔到今日做乜,問佢一句就幫你排好。"],["🧭","你嘅全部殺技","佢越用越識你。一份跨晒所有考試嘅長期側寫,記得你嘅強項、慣性錯法,同埋你真正嘅溫習習慣;根源分析會揀出真正扯你後腿嗰幾點。任何改動都可以還原。"],["📚","資料庫 · RAG","PDF、Word、圖片、音訊,幾大嘅檔案都上載到;講解同出題永遠根據你自己嘅素材,唔會係通用內容。"],["🎒","屠殺準備 · 模擬試","按真實考試結構出一份限時全真試卷,AI 批改之後自動做跨章節根源分析;考前仲有規則、心態同臨場提示。"]],
  ...
  fr: { enter:"Ouvrir l'app", badge:"Ton assassin d'examens, propulsé par l'IA", h1a:"N'importe quel examen,", h1b:"traqué.",
    ...
    feats:[["🗡️","Plan de Meurtre","Repère la cible d'abord. Donne-lui ton programme et tes fichiers : il cartographie chaque notion, distingue l'acquis du fragile et débusque les causes profondes qui plombent tes notes. Tous tes examens planifiés ensemble, avec comptes à rebours et une priorité claire pour aujourd'hui."],["📖","Apprendre + S'entraîner","Puis bande l'arc. Explications et exercices illimités issus de tes propres documents, corrigés immédiatement — au clavier, au stylet ou par photo. Au-delà des exercices : débat, questionnement socratique ou combat de boss contre tes erreurs. Les erreurs reviennent à 1/3/7/15/30 jours jusqu'à ce que ça rentre. Une note injuste ? Discute-en juste sous la question — si ton raisonnement tient, l'IA révise la note."],["💬","Demande au Tueur","Ton mentor, toujours dispo. Il lit tes fichiers, crée des examens, planifie ta semaine, assigne des tâches et réorganise même l'appli — en demandant avant de toucher à quoi que ce soit. Demande-lui quoi réviser maintenant : il te le planifie directement."],["🧭","Tout Ton Art de Tuer","Il apprend à te connaître. Un profil durable sur tous tes examens retient tes forces, tes erreurs récurrentes et ta vraie façon de travailler ; le diagnostic des causes profondes nomme les quelques notions qui te freinent. Tout est réversible."],["📚","Bibliothèque · RAG","PDF, Word, images, audio — toute taille. Cours et questions restent fondés sur tes données, jamais sur du vague."],["🎒","Prépa Massacre · Blanc","Un examen blanc chronométré bâti sur la structure réelle, corrigé par l'IA, suivi d'un bilan des causes profondes — plus règles, mental et rappels du jour J."]],
  ...
  ar: { enter:"ادخل التطبيق", badge:"قاتل امتحاناتك الشخصي بالذكاء الاصطناعي", h1a:"أي امتحان،", h1b:"فريسة.",
    ...
    feats:[["🗡️","خطة القتل","استطلع الهدف أولًا. أعطه منهجك وملفاتك فيرسم خريطة لكل موضوع، ويفصل الراسخ عن الهشّ، ويستخرج الأسباب الجذرية التي تسحب درجاتك بهدوء. كل امتحاناتك مُخطّطة معًا، مع عدّادات تنازلية وأولوية واحدة واضحة لليوم."],["📖","تعلّم + تدرّب","ثم شُدّ القوس. الشروح والأسئلة اللانهائية تنبت من موادّك وتُصحَّح فورًا — اكتب، أو خُطّ بالقلم، أو صوّر إجابتك. وإلى جانب حل الأسئلة: مناظرة، وأسئلة سقراطية، ومعركة ضد أخطائك نفسها. الأخطاء تعود بعد 1/3/7/15/30 يومًا حتى ترسخ. تظن الدرجة ظالمة؟ ناقشها أسفل السؤال نفسه — فإن صحّ منطقك عدّل الذكاء الاصطناعي الدرجة."],["💬","اسأل القاتل","مرشدك جاهز دائمًا. يقرأ ملفاتك، وينشئ الامتحانات، ويخطّط أسبوعك، ويوزّع المهام، بل ويعيد ترتيب التطبيق — ويستأذن قبل أي تغيير. اسأله عمّا ينبغي أن تذاكره الآن، فيرتّبه لك فورًا."],["🧭","كل مهارات القتل لديك","يتعرّف عليك مع الوقت. ملف طويل الأمد عبر كل امتحاناتك يتذكّر نقاط قوّتك وأخطاءك المتكررة وطريقتك الحقيقية في المذاكرة، وتشخيص الأسباب الجذرية يسمّي المواضيع القليلة التي تعوقك فعلًا. وكل تغيير قابل للتراجع."],["📚","المكتبة · RAG","PDF وWord وصور وصوتيات بأي حجم؛ الشرح والأسئلة تبقى مبنية على بياناتك لا على كلام عام."],["🎒","تحضير المذبحة · تجريبي","نموذج كامل مؤقّت مبني على البنية الحقيقية، يصحّحه الذكاء الاصطناعي ثم يتبعه تقرير بالأسباب الجذرية عبر الفصول — مع القواعد والحالة الذهنية وتذكيرات يوم الامتحان."]],
