...
export default function AppShell({ children }) {
  ...
  const killerCustom = S.isDesktop && !!lab.appliedKiller(); // 杀手被挪过位置就别再为它预留右侧一条
  ...
  return (
    <>
      ...
      <div className={`relative z-10 ${showKiller && !labHome && !killerCustom ? "md:pr-[460px] lg:pr-[500px]" : ""}`}>
