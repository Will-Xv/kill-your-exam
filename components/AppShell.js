...
export default function AppShell({ children, initialLayout = null }) {
  ...
  const hideKiller = path.startsWith("/practice") || path.startsWith("/mock") || path.startsWith("/arena") || path === "/chat" || path.startsWith("/onboarding") || path.startsWith("/upload-quiz") || path.startsWith("/tasks");
