...
export default function RouteShell({ layout, children }) {
  ...
  return (
    <div className="w-full" style={{ height: "100dvh", paddingTop: "5rem", paddingBottom: "1rem", boxSizing: "border-box" }}>
      <div style={{ display: "grid", gap: 16, height: "100%", maxWidth: 1360, margin: "0 auto", padding: "0 8px", boxSizing: "border-box", gridTemplateColumns: t.gridTemplateColumns, gridTemplateRows: t.gridTemplateRows, gridTemplateAreas: areas }}>
