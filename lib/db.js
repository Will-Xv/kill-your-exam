...
function openDb() {
  ...
  db.pragma("busy_timeout = 5000");
    ...
    try { db.exec("ALTER TABLE chat_runs ADD COLUMN plan_auth_json TEXT"); } catch {}  // D1:计划门里主人一次性勾选的授权 {approved:[工具名],denied:[工具名]},执行时据此免再弹/直接拒  // 本轮真实改动日志(resume 不清空,累积到最终回复发出为止)
