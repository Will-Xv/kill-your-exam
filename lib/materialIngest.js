  ...
  try {
    ...
    Promise.resolve().then(async () => {
      try {
        ...
        const flag = res && res.verdict === "mismatch" ? 1 : res && res.verdict === "partial" ? 3 : 0; // P3-3:拿不准(unsure)不再弹警告——避免对用户自己上传的大纲误报,也不把AI那句可能夹中文的reason露出来;只在明确别科目(mismatch)或范围超出(partial)时提示
