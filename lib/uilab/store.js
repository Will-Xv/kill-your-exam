...
let S = { enabled: false, isDesktop: false, editing: false, activeId: null, presets: [], working: null, past: [], future: [], loaded: false };
const subs = new Set();
...
export function enterEdit() { const p = activePreset(); set({ editing: true, working: p ? clone(p.layout) : {}, past: [], future: [] }); }
...
export function resetNatural() { set({ past: [...S.past, clone(S.working || {})], future: [], working: {} }); } // 清空 → 各块重新按自然位置播种
