...
export function active() { return !!S.publishedDefault; } // 只有【已发布】才接管实时渲染;草稿(working)只在栏目分配板子里预览,不动你的界面
export function renderPlacement() { return S.publishedDefault || null; } // 实时渲染用的放置表(仅已发布)
