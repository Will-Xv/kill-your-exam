...
export const FEATURE_ITEMS = [
  ...
  // 「我的」是一个【菜单】(没有 href):点开里面是 收件箱 / 设置 / 意见反馈 / 回档。
  // pinned:"nav" ⇒ 只能在导航栏里换位置,不能挪去别处、也不能隐藏或删除。
  { id: "mine",         label: "我的",         icon: "👤", desc: "你的全部杀技 / 收件箱 / 设置 / 意见反馈 / 回档", pinned: "nav", menu: ["profile", "inbox", "settings", "feedback", "checkpoints", "admin", "dev", "bugs"], badge: "inboxUnread" },
  ...
  { id: "tasks",        label: "实践作业",     icon: "🛠️", desc: "编程/实验:动手做+判分", href: "/tasks" },
