...
export const NATIVE_ITEMS = [
  { id: "leaderboard", label: "排行榜", icon: "🏆", desc: "谁做题最多", native: true },
  { id: "hero",        label: "考试卡", icon: "🎯", desc: "当前考试与倒计时", native: true, fixedHome: true },
  { id: "today",       label: "今日任务", icon: "📋", desc: "今天该做什么", native: true },
  { id: "strategy",    label: "备考建议", icon: "🧠", desc: "AI 给的策略", native: true }
];

// "只有按钮"的功能项 —— 放进分区时用 Style-A 通用富模块渲染。
// badge/stat 指向 lib/uilab/stats.js 里的数据源 key。
export const FEATURE_ITEMS = [
  { id: "home",         label: "首页",         icon: "🏠", desc: "回到首页",            href: "/" },
