...
export function getTask(taskId) {
  ...
  return { id: r.id, exam_id: r.exam_id, kp_id: r.kp_id, title: r.title, brief: r.brief, language: r.language, milestones: ms, progress: progMap, appeals, kind: r.kind || "practical", completed_at: r.completed_at || null };
}
