...
export const functionDeclarations = [
  ...
  { name: "plan_overview", description: "跨考试规划总览:把主人【所有考试】按 紧迫度(考试日期)×提分空间(薄弱/未学)×遗忘(到期复习)算优先级,给出每门考试建议今天投入多少分钟,以及【今天最该做的一件事】。主人问『今天该学什么/最该做什么』『我几门考试时间怎么分』『帮我做个总 dashboard』时用。可传 minutes=今天总可用分钟、mode=sprint(临考冲刺,给近考期考试再加权)。", parameters: { type: "object", properties: { minutes: { type: "integer" }, mode: { type: "string", enum: ["normal", "sprint"] } } }, devOnly: true },
