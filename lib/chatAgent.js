...
export const functionDeclarations = [
  ...
  { name: "changes_this_turn", description: "【写最终回复之前必须先调用它】返回你本轮【真实做成/没做成】的每一件事(按发生顺序,含成功与失败)。你的汇报【只能以它返回的内容为准】:它说成功的才能说做了,它说失败的要如实说没成功,它没有的【一律不许说】。返回为空=这轮没有任何改动,那就【一个字都别提改动】,别编。", parameters: { type: "object", properties: {} } },
