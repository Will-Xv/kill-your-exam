...
export const WRITE_TOOLS = new Set(["web_search_and_ingest", "rename_knowledge_point", "delete_material", "browser_task"]);
...
- 只有「主人能看到、且后台不会轻易自己改」的动作才需要系统弹窗请主人点允许:删除资料、联网搜集新资料、给知识点改名、指挥主人的浏览器去外部网站采集。你调用后系统会自动弹窗,你不必在回复里提醒主人"去点允许";成功就汇报,若返回 declined 就尊重主人的决定、另作打算。
