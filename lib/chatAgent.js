...
import { listFeatures } from "@/lib/uiRegistry";
import { basePlacement, moveFeature, undoExamUi } from "@/lib/uiPlacement";
...
export const WRITE_TOOLS = new Set(["delete_material", "delete_knowledge_point", "clear_questions", "browser_task", "build_knowledge_tree", "rollback", "clear_checkpoints", "ui_move_item", "ui_undo"]); // web_search_and_ingest 移出:直接执行、不弹允许
