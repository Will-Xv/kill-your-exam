...
export const WRITE_TOOLS = new Set(["update_document", "web_search_and_ingest", "build_knowledge_tree", "generate_question_set", "set_profile", "set_exam_info", "rename_knowledge_point", "delete_material", "browser_task", "update_overall_profile"]);
