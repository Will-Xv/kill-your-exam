...
// 【已退役 2026-07-19】build_study_plan(把知识点按天均匀铺开)——它和今日任务是两套平行系统、从来没对上过:
// 首页的"学新知识"是【按完成推进】(做够 8 题换下一个),而它把知识点钉死在具体日期上,必然互相打脸。
// 现在改为:周计划只放【真有日期的事】+ 各考核的【这天之前要学完什么】,新知识的推进权只归今日任务那一条。
