...
registerBrick({
  ...
  inputs: [
    ...
    { key: "name", type: "string", required: true, desc: "名字,如 苏格拉底答辩。这会成为首页功能卡的标题,务必简短、≤40 字符(约中文20字/英文40字母),否则卡片放不下" },
    ...
    { key: "winDesc", type: "string", required: false, desc: "达成/满分条件,一句话。也会作为首页卡片的副标题说明,务必≤80 字符,别写长段落" },
