...
export function transcodeToMp4(inputBuffer) {
  ...
  try {
    ...
    const r = spawnSync("ffmpeg", ["-nostdin", "-i", inp, "-c:v", "libx264", "-preset", "veryfast", "-crf", "28", "-pix_fmt", "yuv420p", "-c:a", "aac", "-b:a", "96k", "-movflags", "+faststart", "-y", out], { timeout: 240000, maxBuffer: 1 << 28 });
