...
export function transcodeToMp4(inputBuffer) {
  ...
  try {
    ...
    const r = spawnSync("ffmpeg", ["-nostdin", "-i", inp, "-vf", "scale='min(1280,iw)':-2", "-c:v", "libx264", "-preset", "veryfast", "-crf", "20", "-pix_fmt", "yuv420p", "-c:a", "aac", "-b:a", "128k", "-movflags", "+faststart", "-y", out], { timeout: 240000, maxBuffer: 1 << 28 });
