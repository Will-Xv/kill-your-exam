...
single/multi给4选项,answer写字母(多选如AC);judge写"对"或"错"(中文);fill写标准答案;short写评分要点;explanation解释;difficulty 1~3。资料语言与输出语言不同时术语可保留原文,其余不混语言。${difficultyHint(exam.user_id, exam.id)}
